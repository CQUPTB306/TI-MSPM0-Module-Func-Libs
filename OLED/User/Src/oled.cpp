...
/**
 * @brief OLED类构造函数
 * @param height OLED屏幕高度(32或64)
 * @param I2C_PORT I2C外设实例指针
 */
...
/**
 * @brief 设置指定像素点的状态
 * @param x 像素点的X坐标(0-127)
 * @param y 像素点的Y坐标(32-63)
 * @param state true点亮像素,false熄灭像素
 */
 ...
 * @brief 清除指定显示区域
 * @param x1 区域起始X坐标
 * @param page1 区域起始页(0-7)
 * @param x2 区域结束X坐标
 * @param page2 区域结束页(0-7)
 */
 ...
 * @param y 显示起始Y坐标
 * @param num 要显示的数值
 * @param type 显示格式字符串(如"%.1f")
 * @param length 显示长度
 * @param zeroPad 是否用零填充
 */
...
/**
 * @brief 设置低亮度模式
 * @param enable true启用低亮度,false禁用低亮度
 */
...
/**
 * @brief 控制OLED电源状态
 * @param state true打开电源,false关闭电源
 */
